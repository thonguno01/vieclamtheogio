    ...
    <div class="content_uvut">
        <div class="info_uvut container">
            <div class="info_uvut_title py-4">
                <h1 class="info_uvut_title_text">Ứng viên đã lưu</h1>
            </div>
            <div class="head_btn">
                <form method="POST" action="">
                    <div class="excel">
                        <button value="btn_excel_save_uv" type="submit" class="btn_excel btn_excel_save_uv" name="btn_excel_save_uv">
            ...
            <div class="danh_sach_uvut_table pt-4 table-responsive-xl">
                <table class=" table text-center">
                    ...
                    <tbody>
                        <?php if (!empty($uv_saved)) {
                            $i = 0;
                            foreach ($uv_saved as $list) {
                                $i++; ?>
                                <tr>
                                    ...
                                    <td class="tbd_old_post tbd_old_post_option" scope="col">
                                        <a class="btn_options unsave_uv" data-idsave="<?= $list['id'] ?>" data-iduv="<?= $list['uv_id'] ?>"><img src="/images/delete_btn.png" alt="Delete"></a>
                                    </td>
                                </tr>
                            <? }
                        } else { ?>
