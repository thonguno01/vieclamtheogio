    ...
    <div class="content_infor_work">
        <div class="info_work container">
            ...
            <div class="sm-3 pt-2 dtin_ntd_info">
                ...
                <input type="text" class="form-control" id="ntd_tieude" placeholder="Tiêu đề tin tuyển dụng" oninput="this.value = this.value.replace(/^[' '.]/g, '');">
                    ...
                    <div class="sm-3 pt-2 dtin_ntd_info city_box">
                        ...
                        <div class="n_dtin_ntd_input n_city">
                            <select class="" id="n_city">
                                ...
                                ?>
                                    <option value="<?= $key ?>" <?php if ($ntd_infor['ntd_city'] == $key) echo 'selected'; ?>><?= $value['cit_name'] ?></option>
                                <?php
                                endforeach;
                                ?>
                            </select>
...
<?php $this->load->view("includes/dang_tin_thanh_cong"); ?>