<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Quản lý quận huyện
            <small>Danh sách quận huyện</small>
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="panel-body ">
                    <div class="input-group collapse navbar-collapse " id="navbarSupportedContent">
                        <div class="input-group-append ml-2 navbar_option" >
                            <form class="search_form" style=" display:flex;width: 20%;" method="get" action="/admin/district_list">
                    ...
                    <div class="content_search">
                        <table data-toolbar="#toolbar" data-toggle="table" class="table table-hover" id="list_account">
                            ...
                            <tr>
                                ...
                                <th data-field="name" data-sortable="true">Tên quận huyện</th>
                            </tr>
                            </thead>
                            <tbody class="">
                            <?php if(!empty($list_district)){
                                foreach($list_district as $list){?> 
                                    <tr>
