<div class="n_dky_uv_body">
    <div class="n_dky_uv_right">
        <img src="/images/n_dky_uv.svg" class="img_background" alt="background đăng nhập">
    </div>
    <div class="n_dky_uv_left">
        <h1 class="n_dky_uv_title">ĐĂNG KÝ TÀI KHOẢN ỨNG VIÊN</h1>
        ...
        <div class="n_dky_uv_form">
            ...
            <div class="n_dky_uv_row">
                ...
                <div class="n_dky_uv_col">
                    ...
                    <input class="n_dky_uv_input" id="n_tel" type="text" placeholder="Nhập số điện thoại " oninput="this.value = this.value.replace(/^[' '.]/g, '');">
            ...
            <div class="n_dky_uv_row">
                <div class="n_dky_uv_col">
                    ...
                    <div class="n_ca_lam_radio">
                        ...
                        <div class="n_ca_lam_4">
                            <div class="checkbox_boder" time="none">
                                <div class="checkbox_checked"></div>
                            </div>
            ...
            <div class="n_dky_uv_row">
                <div class="n_dky_uv_col n_col_center">
                    ...
                    <p class="n_dky_uv_qus">Bạn đã có tài khoản?</p>
                    <a href="/" class="n_dky_uv_dn">ĐĂNG NHẬP NGAY</a>
                </div>
            </div>
        </div>
    </div>
