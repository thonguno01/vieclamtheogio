...
<div class="background_login">
    <div class="background-nav">
        ...
        <div class="form_login">
            ...
            <p class="text_2">MỜI BẠN ĐĂNG NHẬP TÀI KHOẢN ỨNG VIÊN</p>
            <form class="form_login_page">
                ...
                <div class="inp_login">
                    ...
                    <img src="/images/n_icon_open_eye.svg" class="icon_see_pass" onclick="show_pass(this)" alt="icon hiển thị mật khẩu">
                </div>
                <p class="error" id="pass-error-container"></p>
                <a href="/quen-mat-khau-uv.html">
            ...
            <div class="text-center pt-3">
                ...
                <h1><a href="/dang-ky-ung-vien.html" class="sign_up_now">ĐĂNG KÝ NGAY</a></h1>
            </div>
        </div>
