...
(function() {
                    ...
                    return function(d) {
                        ...
                        if (1 == f.length)
                            ...
                            if (document.documentElement.doScroll && d) {
                                var e = function() {
                                    try { document.documentElement.doScroll("left") } catch (d) { setTimeout(e, 1); return }
                                    a()
                                };
                                e()
                            }
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, f, e, n) {
                function i(a, o, s, q) { a = { name: b, sender: this, editor: a, data: o, listenerData: e, stop: s, cancel: q, removeListener: k }; return d.call(f, a) === false ? false : a.data }

                function k() { s.removeListener(b, d) }
                var o = a.call(this, b);
                if (o.getListenerIndex(d) < 0) {
                    ...
                    for (var q = o.length - 1; q >= 0; q--)
                        if (o[q].priority <= n) { o.splice(q + 1, 0, i); return { removeListener: k } }
                    o.unshift(i)
                }
            ...
            once: function() {
                var a = arguments[1];
                arguments[1] = function(d) { d.removeListener(); return a.apply(this, arguments) };
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            setTimeout: function(a,
                ...
                g || (g = window);
                f || (f = g);
                return g.setTimeout(function() { b ? a.apply(f, [].concat(b)) : a.apply(f) }, d || 0)
            },
            ...
            convertToPx: function() {
                ...
                return function(d) {
                    ...
                    if (!/%$/.test(d)) { a.setStyle("width", d); return a.$.clientWidth }
                    return d
                }
            }(),
            ...
            fixDomain: function() {
                for (var a;;) try { a = window.parent.document.domain; break } catch (d) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getAscendant: function(a, e) {
            var b = this.$,
                c;
            if (!e) b = b.parentNode;
            for (; b;) { if (b.nodeName && (c = b.nodeName.toLowerCase(), typeof a == "string" ? c == a : c in a)) return new CKEDITOR.dom.node(b); try { b = b.parentNode } catch (d) { b = null } }
            return null
        },
    ...
    (function() {
        function a(a) {
            ...
            return function() { f || a.removeAttribute("id") }
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            isVisible: function() {
                var a = (this.$.offsetHeight || this.$.offsetWidth) && this.getComputedStyle("visibility") != "hidden",
                    f, b;
                if (a && CKEDITOR.env.webkit) { f = this.getWindow(); if (!f.equals(CKEDITOR.document.getWindow()) && (b = f.$.frameElement)) a = (new CKEDITOR.dom.element(b)).isVisible() }
                return !!a
            },
            ...
            hasAttribute: function() {
                function a(d) { d = this.$.attributes.getNamedItem(d); return !(!d || !d.specified) }
                return CKEDITOR.env.ie && CKEDITOR.env.version < 8 ? function(f) { return f == "name" ? !!this.$.name : a.call(this, f) } : a
            }(),
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function u(a, b) { return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0 }!a &&
                    (a = this.getWindow());
                k = a.getDocument();
    ...
    (function() {
        function a(a, b) {
            ...
            if (this.current) g = this.current[v](false, l, o);
                ...
                else { g = d; if (g.type == CKEDITOR.NODE_ELEMENT && !(g = g.getChild(f))) g = o(d, true) === false ? null : d.getNextSourceNode(true, l, o) }
                g && o(g) === false && (g = null)
            }
            for (; g && !this._.end;) {
                this.current = g;
    ...
    (function() {
        function a() {
            ...
            return function(g) { if (c(g) || b(g)) return true; if (d(g) && !a) return a = true; return g.type == CKEDITOR.NODE_TEXT && (g.hasAscendant("pre") || CKEDITOR.tools.trim(g.getText()).length) || g.type == CKEDITOR.NODE_ELEMENT && !g.is(f) ? false : true }
        }
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            trim: function(a, b) {
                ...
                if ((!a || g) && c && c.type == CKEDITOR.NODE_TEXT) {
                    ...
                    this.setStart(c, d);
                    if (g) { this.collapse(true); return }
                }
                c = this.endContainer;
                d = this.endOffset;
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                                        ...
                                        if (h && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                            ...
                                            if (d.test(i)) l = null;
                                                ...
                                                for (var n = l.$.getElementsByTagName("*"), G = 0, C; C = n[G++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) { l = null; break }
                                            l && (r = !!i.length)
                                        } else l = null;
                        ...
                        var J = function(a, b) {
                            ...
                            var c = new CKEDITOR.dom.walker(c),
                                g;
                            for (c.guard = function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; g = c.next();) {
                        ...
                        if (r.type == CKEDITOR.NODE_TEXT)
                            if (CKEDITOR.tools.trim(r.substring(n)).length) h = true;
                                ...
                                h = !r.getLength();
                                if (n == r.getLength()) { if (!(l = r.getNext())) j = r.getParent() } else J(r,
                                    n) && (j = r.getParent())
                            }
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            ...
                            var w = CKEDITOR.dom.walker.whitespaces(),
                                N = CKEDITOR.dom.walker.bookmark();
                            j.evaluator = function(a) { return !w(a) && !N(a) };
    ...
    (function() {
        ...
        function b(a) {
            var b = [];
            a.forEach(function(a) { if (a.getAttribute("contenteditable") == "true") { b.push(a); return false } }, CKEDITOR.NODE_ELEMENT, true);
            return b
        }
                ...
                for (this._.nextNode = null; p;) {
                    ...
                    if (m) p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (m = 0);
                        ...
                        if (CKEDITOR.dtd.$block[l] && p.getAttribute("contenteditable") == "false") {
                            ...
                            if (h) { h.setEndAt(p, CKEDITOR.POSITION_BEFORE_START); if (l != "br") this._.nextNode = p }
                            z = 1
                        } else {
                            if (p.getFirst()) {
                                if (!h) {
    ...
    (function() {
        ...
        function u(a, b, d, g) {
            ...
            if (g.doCallbacks && a.elementCallbacks) {
                a: for (var m = a.elementCallbacks, l = 0, h = m.length, r; l < h; ++l)
                    if (r = m[l](b)) { j = r; break a }if (j) return j
            }
            if (g.doTransform)
            ...
            if (g.doFilter) {
                    ...
                    if (!a && !j) a = null;
                        ...
                        if (m) {
                            ...
                            for (t = m.length; w < t; ++w)
                                if (c(m[w], b, r) === false) { a = null; break a }
                        }
                        if (l) { w = 0; for (t = l.length; w < t; ++w) c(l[w], b, r) }
                        if (a) {
                            w = 0;
                            for (t = a.length; w <
                                t; ++w) e(a[w], b, r, h)
                        }
                        if (j) { w = 0; for (t = j.length; w < t; ++w) e(j[w], b, r, h) }
                        a = r
                    }
                }
                ...
                if (!a.allStyles || a.hadInvalidStyle) { for (y in k) a.allStyles || i[y] ? N.push(y + ":" + k[y]) : w = true; if (N.length) m.style = N.sort().join("; ") } else if (B) m.style = B;
        ...
        function m() { return new CKEDITOR.htmlParser.element("br") }
        ...
        function l(a, b, c) {
            ...
            if (G.$empty[d] || !a.children.length)
                ...
                if (b == "br") {
                    ...
                    b: {
                        g = G[b];
                        for (var f = 0, e = d.length, l; f < e; ++f) { l = d[f]; if (l.type == CKEDITOR.NODE_ELEMENT && !g[l.name]) { g = false; break b } }
                        g = true
                    }
                    if (g) {
                        a.name = b;
        ...
        function v(a, b, c) { var d, g; for (d = 0; d < c.length; ++d) { g = c[d]; if ((!g.check || a.check(g.check, false)) && (!g.left || g.left(b))) { g.right(b, ba); break } } }
                        ...
                        a: {
                            ...
                            if (e)
                                for (h = 0; h < e.length; ++h)
                                    if ((w = d.match(e[h])) && w[0].length == d.length) { c = true; break a }
        ...
        var y = { styles: 1, attributes: 1, classes: 1 },
            ...
            ba = CKEDITOR.filter.transformationsTools = {
                ...
                alignmentToStyle: function(a) {
                    if (!("float" in a.styles)) { var b = a.attributes.align; if (b == "left" || b == "right") a.styles["float"] = b }
                ...
                transform: function(a, b) {
                    if (typeof b == "string") a.name = b;
                        ...
                        a.name = c.element;
                        for (f in g)
                            if (f == "class") { c = a.classes.join("|"); for (j = g[f].split(/\s+/); m = j.pop();) c.indexOf(m) == -1 && a.classes.push(m) } else a.attributes[f] = g[f];
                                ...
                                if (!(d.length >
                                    ...
                                    if (c)
                                        if (CKEDITOR.env.ie && CKEDITOR.env.version < 11) g.$.onreadystatechange = function() {
                                            ...
                                            g.$.onload = function() { setTimeout(function() { q(b, true) }, 0) };
                                            g.$.onerror = function() { q(b, false) }
                                        }
                ...
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (n in a) {
                            ...
                            if (q) { q.split && (q = q.split(",")); for (s = 0; s < q.length; s++) f[q[s]] || b.push(q[s]) }
                        }
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            execCommand: function(a, b) {
                ...
                if (c && c.state != CKEDITOR.TRISTATE_DISABLED && this.fire("beforeCommandExec", d) !== false) { d.returnValue = c.exec(d.commandData); if (!c.async && this.fire("afterCommandExec", d) !== false) return d.returnValue }
                return false
            },
            ...
            parse: function(b) {
                for (var c, d, f = 0, h; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (d = c[1]) {
                        ...
                        if (!h) { this.onTagClose(d); continue }
                    }
                    if (h) h.push(c[0]);
                    else if (d = c[3]) {
                        d = d.toLowerCase();
    ...
    CKEDITOR.htmlParser.comment.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
        ...
        filter: function(a, e) {
            var b = this.value;
            if (!(b = a.onComment(e, b, this))) { this.remove(); return false }
            if (typeof b != "string") { this.replaceWith(b); return false }
            this.value = b;
            return true
        },
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.text.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, e) { if (!(this.value = a.onText(e, this.value, this))) { this.remove(); return false } },
            writeHtml: function(a, e) {
                e && this.filter(e);
                a.text(this.value)
            }
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(f, h, n) {
                ...
                function k() { for (; A.length;) s(A.shift(), m) }
                ...
                function u(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || a == "dt" && b == "dd" || a == "dd" && b == "dt" : false }
                ...
                g.onTagOpen = function(d, f, h, p) {
                    ...
                    if (a(f)) z.push(f);
                        ...
                        if (d == "pre") l = true;
                            ...
                            if (d == "br" && l) { m.add(new CKEDITOR.htmlParser.text("\n")); return }
                            d == "textarea" && (j = true)
                        }
                        if (d == "br") A.push(f);
                        else {
                ...
                g.onText = function(a) {
                    if ((!m._.hasInlineStarted || A.length) && !l && !j) { a = CKEDITOR.tools.ltrim(a); if (a.length === 0) return }
                    var b = m.name,
                ...
                g.onCDATA = function(a) { m.add(new CKEDITOR.htmlParser.cdata(a)) };
    ...
    (function() {
        ...
        function f(a) { return a && (a.type == CKEDITOR.NODE_ELEMENT && a.name in l || a.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) }
        ...
        function o(a, b) { return a.replace(b, function(a, b, c) { a.indexOf("<textarea") === 0 && (a = b + u(c).replace(/</g, "&lt;").replace(/>/g, "&gt;") + "</textarea>"); return "<cke:encoded>" + encodeURIComponent(a) + "</cke:encoded>" }) }
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (;;) {
                    e = f.name;
                    if (!(n = a.onElementName(b, e))) { this.remove(); return false }
                    f.name = n;
                    if (!(f = a.onElement(b, f))) { this.remove(); return false }
                    if (f !== this) { this.replaceWith(f); return false }
                    if (f.name == e) break;
                    if (f.type != CKEDITOR.NODE_ELEMENT) { this.replaceWith(f); return false }
                    if (!f.name) { this.replaceWithChildren(); return false }
                }
                e = f.attributes;
                var i, k;
                for (i in e) {
        ...
        CKEDITOR.replaceAll = function() {
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                var c = null,
                    e = a[b];
                if (e.name || e.id) {
                    if (typeof arguments[0] == "string") { if (!RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)").test(e.className)) continue } else if (typeof arguments[0] == "function") { c = {}; if (arguments[0](e, c) === false) continue }
                    this.replace(e, c)
                }
            }
        };
    ...
    (function() {
            ...
            proto: {
                ...
                insertText: function(a) {
                    ...
                    if (!b) {
                        ...
                        if (e.test(a)) var f = "<" + c + ">",
                            l = "</" + c + ">",
                            a = f + a.replace(e, function() { return l + f }) + l
                    }
                    a = a.replace(/\n/g, "<br>");
        ...
        var q = function() {
                ...
                function e(b) { return b && a(b) && (b.is(l.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) }
                ...
                return function(h, i, v) {
                    ...
                    if (!s.checkReadOnly()) {
                        var t = (new CKEDITOR.dom.elementPath(s.startContainer, s.root)).blockLimit || s.root,
                            i = { type: i, dontFilter: q, editable: h, editor: o, range: s, blockLimit: t, mergeCandidates: [], zombies: [] },
                            o = i.range,
                            q = i.mergeCandidates,
                            x, y, B, w;
                        ...
                        if (x = v) {
                            ...
                            if ((M = x.startPath().block) && !(M.getChildCount() == 1 && M.getBogus())) a: {
                                ...
                                if (w.getChildCount() == 1 && a(D = w.getFirst()) && D.is(k)) {
                                    ...
                                    x = 0;
                                    for (q = M.count(); x < q; x++) { o = M.getItem(x); if (!o.is(r)) break a }
                        ...
                        if (!i.dontMoveCaret) {
                            for (E = a(I.startContainer) && I.startContainer.getChild(I.startOffset - 1); E && a(E) && !E.is(l.$empty);) {
                                if (E.isBlockBoundary()) I.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
                                    ...
                                    if (e(E) && E.getHtml().match(/(\s|&nbsp;)$/g)) { U = null; break }
                                    U = I.clone();
    ...
    (function() {
        function a() {
            ...
            if (!a) { a = b || this.getSelection(1); if (!a || a.getType() == CKEDITOR.SELECTION_NONE) return }
                ...
                var a = p ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        if (t == -1 || t == e.length - 1 && l < 0) {
                            ...
                            h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                            e = d.childNodes;
                            if (!h) { f = e[e.length - 1]; return f.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: f, offset: f.nodeValue.length } }
                        ...
                        for (; h > 0;) try {
                            ...
                            f = g
                        } catch (o) { return { container: d, offset: a(f) } }
                            ...
                            if (p) {
                                ...
                                for (q = 0; q < a.length; q++) {
                                    ...
                                    n.setStart(h.startContainer.$,
                                        h.startOffset);
                                    try { n.setEnd(h.endContainer.$, h.endOffset) } catch (t) {
    ...
    (function() {
        ...
        var P = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            r = { a: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 },
            L = /\s*(?:;\s*|$)/,
            H = /#\((.+?)\)/g,
                        ...
                        if (a[k]) {
                            ...
                            if (o = !f) {
                                if (k = k == "div") {
                                    a: {
                                        k = i.getChildren();o = 0;
                                        for (var s = k.count(); o < s; o++) { var q = k.getItem(o); if (q.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[q.getName()]) { k = true; break a } }
                                        k = false
                                    }
                                    k = !k
                                }
    ...
    */
    ...
    (function() {
        ...
        function r(a, f, d) {
            ...
            if (a.checkBoundaryOfElement(b, CKEDITOR.START) && a.checkBoundaryOfElement(b, CKEDITOR.END)) { for (var c; b && b.type == CKEDITOR.NODE_ELEMENT && (c = b.getParent()) && 1 == c.getChildCount() && !(b.getName() in f);) b = c; return b.type == CKEDITOR.NODE_ELEMENT && b.getName() in f && b }
        }
            ...
            afterInit: function(a) {
                ...
                (b = b && b.dataFilter) && b.addRules({
                    elements: {
                        ...
                        "cke:embed": function(b) { return !d(b) ? null : e(a, b) }
                    }
                }, 5)
            }
        })
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("link", {
            ...
            init: function(c) {
                ...
                c.on("doubleclick", function(a) { a.data.dialog == "link" && a.data.link && c.getSelection().selectElement(a.data.link) }, null, null, 20);
    ...
    (function() {
        var b = { readOnly: 1, exec: function(a) { if (a.fire("save") && (a = a.element.$.form)) try { a.submit() } catch (b) { a.submit.click && a.submit.click() } } };
    ...
    CKEDITOR.tools.buildTableMap = function(p) {
        for (var p = p.$.rows, o = -1, q = [], r = 0; r < p.length; r++) {
            ...
            for (var k = -1, u = 0; u < p[r].cells.length; u++) {
                var t = p[r].cells[u];
                for (k++; q[o][k];) k++;
                for (var m = isNaN(t.colSpan) ? 1 : t.colSpan, t = isNaN(t.rowSpan) ? 1 : t.rowSpan, v = 0; v < t; v++) { q[o + v] || (q[o + v] = []); for (var s = 0; s < m; s++) q[o + v][k + s] = p[r].cells[u] }
                k += m - 1
            }
        }
        return q
