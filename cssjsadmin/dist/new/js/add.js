$(document).ready(function() {
    ...
    $('.btn_up_post').click(function() {
        ...
        if (tieude == '') {
            ...
            $.ajax({
                url: '/admin/Submit_form/tieu_de_alias',
                type: "POST",
                dataType: "JSON",
                async: false,
                data: {
        ...
        // Loại công việc
        var congty = $('#new_user').val();
        var flag_congty = false;
        if (congty == '' || congty == 0) {
            $('.n_eror_user').html('Không để trống mục này.');
            flag_congty = false;
        } else {
            $('.n_eror_user').html('');
            flag_congty = true;
        ...
        if (cat_des > 0) {
            if (chi_tiet == '') {
                ...
                $.ajax({
                    url: '/admin/Submit_form/chi_tiet_cong_viec',
                    type: "POST",
                    dataType: "JSON",
                    async: false,
                    data: {
        ...
        if (flag == true && flag_tieude == true && flag_type_congviec == true && flag_congty == true) {
